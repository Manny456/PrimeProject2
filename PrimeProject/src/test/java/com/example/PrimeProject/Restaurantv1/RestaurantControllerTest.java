...
import com.example.PrimeProject.AdminReview.AdminReviewController;
...
@ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = AdminReviewController.class))
